const recipeSearch = "https://api.spoonacular.com/recipes/complexSearch?number=1&addRecipeInformation=true&apiKey=1b895093492742b1a06fd7a7daecb281";
...
function displayRecipes(recipes) {
    ...
    for (let i = 0; i < recipes.length; i++) {
        ...
        let recipeCard = '<div class="card" style="width: 100%;">' +
